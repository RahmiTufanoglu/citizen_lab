...
const Color backgroundGreyLight = Color(0xFFEFEFEF);
const Color backgroundGreyDark = Color(0xFFE9E9E9);
const Color backgroundWhite = Color(0xFFFFFFFF);

const Color mainColor = Color(0xFF009274);

/*const Map<int, int> card_colors = {
  0xFF61BD6D: 0xFF000000,
  0xFF1ABC9C: 0xFF000000,
  0xFF54ACD2: 0xFF000000,
  0xFF2C82C9: 0xFFFFFFFF,
  0xFF41A85F: 0xFF000000,
  0xFF00A885: 0xFFFFFFFF,
  0xFF3D8EB9: 0xFFFFFFFF,
  0xFF2969B0: 0xFFFFFFFF,
};*/
...
List<CardColors> cardColors = [
  ...
  CardColors(0xFF41A85F, 0xFF000000),
  CardColors(0xFF00A885, 0xFFFFFFFF),
  CardColors(0xFF3D8EB9, 0xFFFFFFFF),
  CardColors(0xFF2969B0, 0xFFFFFFFF),
  CardColors(0xFFF7DA64, 0xFF000000),
  CardColors(0xFFFBA026, 0xFF000000),
  CardColors(0xFFEB6B56, 0xFF000000),
